...
namespace RenownedGames.ApexEditor
{
    ...
    public static class ApexUtility
    {
        ...
        static ApexUtility()
        {
            ...
            DefaultAssemblies = new string[3]
            {
                "Apex",
                "Apex.Demo",
                "ApexEditor"
        ...
        /// </summary>
        public static bool IncludeAllAssemblies
        {
            get
            {
                return AllAssemblyScope;
            }
            internal set
            {
                AllAssemblyScope = value;
            }
        }
        ...
        /// </summary>
        public static bool IncludeDefaultAssemblies
        {
            get
            {
                return DefaultAssemblyScope;
            }
            internal set
            {
                DefaultAssemblyScope = value;
            }
        }
        ...
        public static bool InAssemblyScope(System.Reflection.Assembly assembly)
        {
            ...
            if (DefaultAssemblyScope 
                && (assemblyName.Name == DEFAULT_RUNTIME_ASSEMBLY_NAME || assemblyName.Name == DEFAULT_EDITOR_ASSEMBLY_NAME))
            {
                return true;
            }
