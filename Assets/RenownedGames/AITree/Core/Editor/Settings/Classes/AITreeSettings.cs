...
namespace RenownedGames.AITreeEditor
{
    ...
    public sealed class AITreeSettings : ScriptableSingleton<AITreeSettings>
    {
        ...
        [SerializeField]
        [Tooltip("Custom hot key listener for Behaviour Tree graph, recommended to use in Unity 2022.3 and higher.")]
        private bool hotKeyListener = true;
#endif
...
#if UNITY_2022_3_OR_NEWER
        public bool HotKeyListener()
        {
            return hotKeyListener;
        }

        public void HotKeyListener(bool value)
        {
